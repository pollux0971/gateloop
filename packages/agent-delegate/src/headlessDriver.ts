...
// The seam-type contract (CliKind, AgentEvent, DelegationTaskPacket, SandboxHandle,
// ExternalAgentDriver, …) lives in ./seam-types so the ProviderDriver foundation
// survives independently of this spawn-CLI implementation (EPIC-035 TIER B). The
// package index re-exports them, so external import sites are unchanged.
